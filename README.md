...
# **LOST PROPHECIES**
**A Vanilla+ Modlist for OpenMW 0.51
...
- **~155 GB of free disk space** (less if you delete downloaded files after install)  
...
- *Note: LP is built for 0.51, but newer versions are typically compatible.*
